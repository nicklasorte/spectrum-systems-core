...
class PDFAdmissionGuardTests(unittest.TestCase):
    ...
    def test_valid_pdf_passes_guard(self) -> None:
        ...
        self._write_pdf()
        result = PDFAdmissionGuard().validate(self.source_id, str(self.repo_root))
    ...
    def test_private_use_only_true_required_via_code(self) -> None:
        ...
        notes_dir = self.repo_root / "raw" / "notes" / self.source_id
        books_dir = self.repo_root / "raw" / "books" / self.source_id
